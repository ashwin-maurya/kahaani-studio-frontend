...
import DestinationAdminContext from "../AdminContexts/DestinationContexts/DestinationAdminContext";
import { FaCloudUploadAlt } from "react-icons/fa";

const Destinations = () => {
  const { destinations, fetchDestinations, updateImageURL } = useContext(
